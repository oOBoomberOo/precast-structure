...
public final class PrecastStructureForgeClientEvents {
  ...
  public static void onRenderLevel(RenderLevelStageEvent event) {
    ...
    // AFTER_TRANSLUCENT_BLOCKS is unreliable with fabulous targets; AFTER_PARTICLES is after
    // deferred.
    RenderLevelStageEvent.Stage expected =
        late
    ...
    WorldHologramRender.renderAll(
        event.getPoseStack(), event.getCamera().getPosition(), partialTick);
  }
}
