...
/**
 * Legacy placement-only strip of embedded item/loot NBT; new captures empty inventories in-world
 * first.
 */
public final class InventoryNbt {
  private static final String[] LIST_OR_COMPOUND_KEYS = {
    "Items", "Inventory", "item", "Item", "RecordItem", "Book", "Page", "page", "item_stack"
  };

  private static final String[] LOOT_KEYS = {
    "LootTable", "loot_table", "LootTableSeed", "loot_table_seed"
  };
