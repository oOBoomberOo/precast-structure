...
public final class BlueprintItemData {
    ...
    /**
     * Migrates legacy {@code custom_data.PrecastStructure} onto
     * {@link ModDataComponents#BLUEPRINT_STRUCTURE} for every stack in the inventory.
     */
    ...
    public static void migrateStack(ItemStack stack) {
        ...
        readLegacyCustomData(stack, null).ifPresent(blueprint ->
            write(stack, blueprint, stack.get(DataComponents.CUSTOM_NAME))
        );
    }
