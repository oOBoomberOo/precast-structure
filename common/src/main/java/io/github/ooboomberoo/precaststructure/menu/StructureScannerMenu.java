...
public class StructureScannerMenu extends AbstractContainerMenu {
    ...
    public StructureScannerMenu(int containerId, Inventory inventory, FriendlyByteBuf buf) {
        this(containerId, inventory, buf.readBlockPos(), buf.readUtf(StructureScannerBlockEntity.MAX_NAME_LENGTH), null);
    }

    public StructureScannerMenu(int containerId, Inventory inventory, StructureScannerBlockEntity scanner) {
    ...
    public StructureScannerBlockEntity getScanner() {
        ...
        return access.evaluate(
            (level, pos) -> level.getBlockEntity(pos) instanceof StructureScannerBlockEntity found ? found : null,
            null
        );
    }
