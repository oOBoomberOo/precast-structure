...
/**
 * Moves legacy {@code custom_data.PrecastStructure} onto {@link
 * io.github.ooboomberoo.precaststructure.registry.ModDataComponents#BLUEPRINT_STRUCTURE} when a
 * world/server starts and when players join.
 */
