...
/**
 * Soft Create special-block module: NBTProcessors capture/apply, schematic material costs (encased
 * shaft → shaft), bracket extras / NBT rotation, and kinetic hologram meshes. Inventories are
 * emptied in-world during capture ({@link
 * io.github.ooboomberoo.precaststructure.structure.ContainerCapture}); machine config / brackets
 * stay in NBT.
 *
