  ...
  public void appendHoverText(
    ...
    if (optional.isEmpty()) {
      tooltipComponents.add(
          Component.translatable("tooltip.precast_structure.empty_blueprint")
    ...
    tooltipComponents.add(
        Component.translatable(
                "tooltip.precast_structure.dimensions",
                blueprint.size().getX(),
                blueprint.size().getY(),
                blueprint.size().getZ())
    ...
    for (Map.Entry<net.minecraft.world.item.Item, Integer> entry :
        blueprint.requiredItems(registries).entrySet()) {
      if (shown >= MAX_TOOLTIP_MATERIALS) {
        tooltipComponents.add(
            Component.translatable("tooltip.precast_structure.more_materials", total - shown)
