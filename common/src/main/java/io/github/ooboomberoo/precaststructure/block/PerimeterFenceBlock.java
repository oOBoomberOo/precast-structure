...
/** Perimeter fence that notifies scanners when the scan frame changes. */
public class PerimeterFenceBlock extends FenceBlock {
    public PerimeterFenceBlock(Properties properties) {
        super(properties);
    }
