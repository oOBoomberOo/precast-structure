...
/**
 * Placement preview for held precast structures via {@link HologramRenderSystem}. Placeable
 * previews stay cyan-hologram; blocked previews tint red (no bounding box).
 *
...
public final class StructureGhostRenderer {
  ...
  public static void render(PoseStack poseStack, Vec3 cameraPosition, float partialTick) {
    ...
    boolean overlapsDeploy =
        StructureDeploymentManager.overlapsActiveDeploy(
