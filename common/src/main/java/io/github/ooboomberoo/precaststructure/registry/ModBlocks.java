...
public final class ModBlocks {
    ...
    public static final RegistrySupplier<Block> PERIMETER_FENCE_GATE = BLOCKS.register("perimeter_fence_gate", () -> new PerimeterFenceGateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.5F).sound(SoundType.WOOD), WoodType.OAK));
