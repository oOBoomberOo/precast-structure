...
public final class ModBlocks {
  public static final DeferredRegister<Block> BLOCKS =
      DeferredRegister.create(PrecastStructureMod.MOD_ID, Registries.BLOCK);

  public static final RegistrySupplier<Block> PLATFORM_FLOOR =
      BLOCKS.register(
          "platform_floor",
          () ->
              new PlatformFloorBlock(
  ...
  public static final RegistrySupplier<Block> PERIMETER_FENCE =
      BLOCKS.register(
          "perimeter_fence",
          () ->
              new PerimeterFenceBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.WOOD)
                      .strength(2.5F)
                      .sound(SoundType.WOOD)));
  public static final RegistrySupplier<Block> PERIMETER_FENCE_GATE =
      BLOCKS.register(
          "perimeter_fence_gate",
          () ->
              new PerimeterFenceGateBlock(
                  WoodType.OAK,
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.WOOD)
                      .strength(2.5F)
                      .forceSolidOn()
                      .sound(SoundType.WOOD)));
  public static final RegistrySupplier<Block> METAL_SCAFFOLD =
      BLOCKS.register(
          "metal_scaffold",
          () ->
              new StructureFrameBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.METAL)
                      .strength(3.5F, 6.0F)
                      .sound(SoundType.METAL)
  ...
  public static final RegistrySupplier<Block> STRUCTURE_SCANNER =
      BLOCKS.register(
          "structure_scanner",
          () ->
              new StructureScannerBlock(
                  BlockBehaviour.Properties.of()
                      .mapColor(MapColor.COLOR_CYAN)
                      .strength(3.5F)
                      .sound(SoundType.METAL)
                      .requiresCorrectToolForDrops()));
  public static final RegistrySupplier<Block> STRUCTURE_PRINTER =
      BLOCKS.register(
          "structure_printer",
          () ->
              new StructurePrinterBlock(
                  BlockBehaviour.Properties.of()
  ...
  public static final RegistrySupplier<Block> HOLOGRAM_COLLIDER =
      BLOCKS.register(
          "hologram_collider",
          () ->
